...
const navigationItems = [
  ...
  {
    id: "user-management" as DashboardSection,
    label: "User Management",
    icon: Shield,
    description: "Search users and manage blocks",
  },
];
...
export const DashboardSidebar: React.FC<SidebarProps> = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "p-4 border-b border-purple-100 bg-purple-50 flex items-center",
                  ...
                  <>
                    ...
                    {isActive && (
                      <div className="flex flex-col gap-1">
                        ...
                        <div className="w-1.5 h-1.5 bg-blue-600 rounded-full animate-pulse animate-delay-200"></div>
                      </div>
                    )}
                  </>
                )}
        ...
        <div className="px-4 py-4 border-t border-purple-100 mt-8 bg-purple-50 rounded-lg mx-2">
          ...
          <div className="space-y-2 text-sm text-gray-700 leading-relaxed">
            {activeSection === "overview" && (
              <p className="pl-3 border-l-2 border-purple-300">
                View user statistics, activity metrics, and system overview.
              </p>
            )}
            {activeSection === "analytics" && (
              <p className="pl-3 border-l-2 border-blue-300">
                Explore visual charts, trends, and performance analytics.
              </p>
            )}
            {activeSection === "user-statistics" && (
              <p className="pl-3 border-l-2 border-green-300">
                View detailed user statistics, rankings, and engagement metrics.
              </p>
            )}
            {activeSection === "user-management" && (
              <p className="pl-3 border-l-2 border-orange-300">
                Search for users and manage blocked accounts with admin
                controls.
              </p>
            )}
          </div>
