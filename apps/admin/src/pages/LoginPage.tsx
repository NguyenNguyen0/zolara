      ...
      <div className="max-w-md w-full space-y-8 relative z-10">
        <div className="text-center">
          <div className="flex justify-center mb-4">
            <img src={logoSrc} alt="Zolara Logo" className="h-16 w-auto drop-shadow-lg" />
          </div>
          <h2 className="mt-6 text-3xl font-extrabold text-gray-800 drop-shadow-sm">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <Input
                  ...
                  disabled={isLoading}
                  className={`bg-white border-gray-300 text-gray-900 placeholder:text-gray-500 ${formErrors.email ? 'border-red-500' : ''}`}
                />
                {formErrors.email && (
              ...
              <div>
                ...
                <div className="relative">
                  <Input
                    ...
                    disabled={isLoading}
                    className={`bg-white border-gray-300 text-gray-900 placeholder:text-gray-500 pr-10 ${formErrors.password ? 'border-red-500' : ''}`}
                  />
                  <button
                    type="button"
