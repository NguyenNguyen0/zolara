...
export default function MessageInput() {
	...
	return (
		<View className="flex-row items-center px-2 py-4 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700">
			<View className="flex-1 bg-secondary-light dark:bg-secondary-dark rounded-full px-4 py-1">
				<TextInput
					...
					className="text-gray-900 dark:text-light"
				/>
			</View>
