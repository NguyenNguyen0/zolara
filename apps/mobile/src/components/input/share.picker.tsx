...
interface SharePickerProps {
	...
	placeholder?: string;
	zIndex?: number;
	renderTrigger?: (selectedItem: PickerItem | undefined, isDark: boolean, open: boolean) => React.ReactNode; // Custom trigger
}
			...
			{renderTrigger ? (
				...
				<TouchableOpacity
					...
					style={{
						...
						borderColor: open ? APP_COLOR.PRIMARY : (isDark ? APP_COLOR.GRAY_700 : APP_COLOR.GRAY_200),
						borderWidth: 2,
						borderRadius: 8,
						minHeight: 56,
				...
				>
					...
					>
						...
						<View style={{ 
							...
							paddingVertical: 12,
							borderBottomWidth: 1,
							borderBottomColor: isDark ? APP_COLOR.GRAY_700 : APP_COLOR.GRAY_200,
						}}>
							<Text style={{
								fontSize: 18,
								fontWeight: '600',
							...
							<TouchableOpacity onPress={() => setOpen(false)}>
								<Ionicons name="close" size={24} color={isDark ? APP_COLOR.LIGHT_MODE : APP_COLOR.DARK_MODE} />
							</TouchableOpacity>
						</View>
