...
export default function SignUpEmail() {
    ...
    const isNextDisabled = !email.trim() || !agreeToTerms || !agreeToSocialTerms;
                ...
                <View>
                    ...
                    <View className="mb-6">
                        ...
                        <ShareRadio
                            ...
                            questionColor={isDark ? APP_COLOR.LIGHT : APP_COLOR.DARK}
                        ...
                        <ShareRadio
                            ...
                            onRadioPress={() => setAgreeToSocialTerms(!agreeToSocialTerms)}
