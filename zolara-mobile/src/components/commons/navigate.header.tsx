        ...
        <View className="flex-row items-center justify-between gap-2">
          ...
          {hasRightIcons && (
            <View className="flex-row gap-1">
              {showSearch && (
                <TouchableOpacity
                  onPress={() => router.navigate("/(screens)/(user)/search")}
                  className="w-10 h-10 rounded-full items-center justify-center"
                >
              ...
              {showCreateGroup && (
                <TouchableOpacity
                  ...
                  className="w-10 h-10 rounded-full items-center justify-center"
                >
                  <MaterialIcons name="groups" size={26} color="white" />
                </TouchableOpacity>
              )}
              {showAddFriend && (
                <TouchableOpacity
              ...
              {showSettings && (
                <TouchableOpacity
                  onPress={() => router.navigate("/(screens)/(user)/setting")}
                  className="w-10 h-10 rounded-full items-center justify-center"
                >
              ...
              {showChatbot && (
                <TouchableOpacity
                  onPress={() => router.navigate("/(screens)/(user)/chatbot")}
                  className="w-10 h-10 rounded-full items-center justify-center"
                >
