...
import { MOCK_FRIEND_CHAT } from '@/src/mocks/conversation';
...
export default function ConversationDetail() {
	...
	const [conversation] = useState<Conversation>(MOCK_FRIEND_CHAT);
	...
	const getOnlineStatus = (): string => {
		if (conversation.type === 'GROUP') {
			return t('members', { count: conversation.members.length });
		}
		if (conversation.type === 'FRIEND') {
			return t('onlineJustNow');
		}
